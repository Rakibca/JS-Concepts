export const interplanetaryDestinationsArr = [
  ...
  {
    destination: "Venusian Cloud City",
    distanceKM: 41400000,
    travelTimeDays: 300,
    priceUSD: 750000,
    description:
  ...
  {
    destination: "Asteroid Mining Colony Zeta",
    distanceKM: 420000000,
    travelTimeDays: 320,
    priceUSD: 1500000,
    description:
  ...
  {
    destination: "Martian Metropolis",
...
const shortSpaceTripsArr = [
  {
    ...
    priceUSD: 10000,
    description:
      "Take a quick trip to the Moon and witness Earthrise from space.",
  },
  {
    ...
    priceUSD: 5000,
    description:
      "Experience weightlessness and breathtaking views of Earth by orbiting our home planet.",
  },
  {
